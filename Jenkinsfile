            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user5') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user5/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user5') {
                    ...
                    openshift.tag("user5/gateway-canary:latest", "user5/gateway:latest")
